            ...
            <form method="get">
                <div class="form-group">
                    ...
                    <select id="categoria" name="filtros[categoria]" class="form-control">
                        ...
                        <option value="<?php echo $cat['id']; ?>" <?php echo ($cat['id']==$filtros['categoria'])?'selected="select':''; ?>><?php echo utf8_encode($cat['nome']); ?></option>
                        <?php endforeach; ?>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="preco" name="filtros[preco]" class="form-control">
                        <option value=""></option>
                        <option value="0-50"<?php echo ($filtros['preco'] == '0-50')?'selected="select':''; ?>>R$ 0 - 50</option>
                        <option value="51-100" <?php echo ($filtros['preco'] == '51-100')?'selected="select':''; ?>>R$ 51 - 100</option>
                        <option value="101-200" <?php echo ($filtros['preco'] == '101-200')?'selected="select':''; ?>>R$ 101 - 200</option>
                        <option value="201-500" <?php echo ($filtros['preco'] == '201-500')?'selected="select':''; ?>>R$ 201 - 500</option>
                    </select>
                </div>
                ...
                <div class="form-group">
                    ...
                    <select id="estado" name="filtros[estado]" class="form-control">
                        ...
                        <option value="2" <?php echo ($filtros['estado'] == '2')?'selected="select':''; ?>>Ótimo</option>
                    </select>
                </div>
